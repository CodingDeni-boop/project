...
The k-Nearest Neighbors model showed strong recall (0.965) and F1 score (0.904), but its ROC AUC was substantially lower (0.709), and its performance on negative class prediction was poor. This imbalance indicates that kNN is biased toward the majority class and may struggle in settings requiring reliable discrimination across all classes.
